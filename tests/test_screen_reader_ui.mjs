...
const controller = {
    ...
    pickerOpen: false,
    knobRows() { return []; },
    load() { this.io.announce("9W9, 1 of 2, 6 controls"); },
...
assert.deepEqual(spoken.slice(0, 2), ["9W9", "9W9, 1 of 2, 6 controls"],
...
console.log("PASS: accessible list, announcement order, drum mute, and Main lock");
